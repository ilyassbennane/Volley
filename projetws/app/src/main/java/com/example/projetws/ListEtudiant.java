...
public class ListEtudiant extends AppCompatActivity {
    ...
    private void fetchStudentsFromServer() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, fetchUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                studentAdapter = new EtudiantAdapter(ListEtudiant.this, students);
    ...
    private void deleteStudent(int studentId) {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, deleteUrl, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Toast.makeText(ListEtudiant.this, "Student deleted successfully", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ListEtudiant.this, "Error deleting student", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void sendUpdateRequest(final Etudiant student) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, updateUrl, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Toast.makeText(ListEtudiant.this, "Student updated successfully", Toast.LENGTH_SHORT).show();
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ListEtudiant.this, "Error updating student", Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
